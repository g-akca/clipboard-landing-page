...
function DownloadSection() {
  return (
    <section className="flex flex-col gap-14 tablet:gap-12 text-center">
      ...
      <div className="flex flex-col gap-6 items-center tablet:flex-row tablet:gap-2 tablet:justify-center">
