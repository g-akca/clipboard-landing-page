...
function HeroSection() {
  return (
    <section className="flex flex-col items-center gap-16 tablet:gap-14">
      <img src={logo} alt="Logo image" className="w-31.25" />

      <div className="flex flex-col gap-14 tablet:gap-12">
        <div className="flex flex-col gap-4 text-center">
          <h1 className="font-semibold text-[32px] tablet:text-[40px] leading-[125%] tracking-[-0.5px] tablet:tracking-[-0.75px] text-gray-700">A history of everything you copy</h1>
