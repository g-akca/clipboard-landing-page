...
function ToolsSection() {
  return (
    <section className="flex flex-col gap-22 tablet:gap-18 text-center">
      <div className="flex flex-col gap-4">
        <h2 className="font-semibold text-[28px] tablet:text-[36px] leading-[125%] tracking-[-0.5px] tablet:tracking-[-0.6px] text-gray-700">Supercharge your workflow</h2>
      ...
      <div className="flex flex-col gap-16 tablet:gap-12 items-center">
        <div className="flex flex-col gap-10 items-center max-w-98">
          ...
          <div className="flex flex-col gap-4">
            ...
            <p className="text-base leading-base tracking-base">Ensure sensitive information never makes its way to your clipboard by excluding certain sources.</p>
          </div>
        </div>
        ...
        <div className="flex flex-col gap-10 items-center max-w-98">
          ...
          <div className="flex flex-col gap-4">
            ...
            <p className="text-base leading-base tracking-base">Remove unwanted formatting from copied text for a consistent look.</p>
          </div>
        </div>
        ...
        <div className="flex flex-col gap-10 items-center max-w-98">
          ...
          <div className="flex flex-col gap-4">
            ...
            <p className="text-base leading-base tracking-base">Quick preview of all snippets on your Clipboard for easy access.</p>
          </div>
        </div>
      </div>
    </section>
